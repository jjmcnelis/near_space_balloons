...
<img src="docs/img/readme_0.jpg" width="60%" />

#### My linux box

Boots to Debian 10 (buster) by default. A dedicated AWS user uses the CLI to integrate with AWS cloud. Build and push code directory to attached microcontrollers, or use the Arduino Cloud API to push code to boards with a wifi module (ESP32). All third-party apps run in Docker containers. I manage them through simple browser interface (1). GUI apps served by X.Org Server are accessible on LAN.
...
<img src="docs/img/readme_1.jpg" width="60%" />
